          ...
          <div className="AboutMeCard">
            <section className="tc grow dib f3-ns no-underline black-90 pa4">
              <Card className={classes.card}>
                <CardActionArea>
                  <CardMedia className={classes.media} image="https://media.licdn.com/dms/image/C5603AQHP0vsKuSmMEQ/profile-displayphoto-shrink_200_200/0?e=1570060800&v=beta&t=zILrhUquW88J-qyV4sjnCPUdrBxPi7phYtBCcl76njQ" title="IrenaPhoto" />
                  
                  <CardContent>
                    <Typography gutterBottom variant="h5" component="h2">
                      Irena Popova
                    </Typography>
                    <Typography component="p">I successfully made a career change.
                    ...
                    I intend to .... blababalbala</Typography>
                  </CardContent>
                ...
                <CardActions>
                  ...
                  <Button>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      href="https://www.linkedin.com/in/irenapopova"
                      title="LinkedIn">
                      <svg
                        class="dib h2 w2"
                        fill="currentColor"
